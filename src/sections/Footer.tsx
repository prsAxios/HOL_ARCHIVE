      ...
      {/* <div style={{
        ...
        <div className="f-col" style={{ opacity: 0 }}>
          ...
          <p style={{ ...BODY, lineHeight: 2.4 }}>
            ...
            +91 7977217008<br />
            <span style={{ color: 'var(--hol-text)', borderBottom: '1px solid #C2AE6D', paddingBottom: '1px', cursor: 'pointer' }}>
              Instagram
            </span>
          </p>
        </div>
        ...
        <div className="f-col" style={{ opacity: 0 }}>
          ...
          <p style={{ ...BODY, opacity: 0.6, maxWidth: '200px', lineHeight: 1.8 }}>
            ...
            <div key={i} style={{ aspectRatio: '1/1', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <div
                ...
                style={{
                  width: '36%', height: '36%',
                  borderRadius: '50%',
                  backgroundColor: isLogo ? 'var(--hol-text)' : 'var(--hol-border)',
                  flexShrink: 0,
...
const LBL: React.CSSProperties = {
  ...
  marginBottom: '22px', textTransform: 'uppercase', fontFamily: 'Sora, sans-serif', fontWeight: 400,
}
const CITY: React.CSSProperties = {
  fontSize: '38px', fontWeight: 300, color: 'var(--hol-text)',
  marginBottom: '12px', fontFamily: 'Sora, sans-serif', letterSpacing: '-0.02em',
  transition: 'color 0.4s ease',
}
const BODY: React.CSSProperties = {
  fontSize: '15px', color: 'var(--hol-muted)',
  lineHeight: 1.85, fontFamily: 'Sora, sans-serif', fontWeight: 300,
  transition: 'color 0.4s ease',
}
